...
export default function CtaSection() {
  return (
    <section className="mt-32">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-500 via-emerald-500 to-emerald-500 px-6 py-16 text-center shadow-xl sm:px-16">
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/account/signup"
              className="inline-flex h-12 items-center justify-center rounded-xl bg-white px-8 font-semibold text-emerald-600 shadow-md transition hover:bg-stone-50"
            >
              Get Started Free
            </Link>
            <Link
