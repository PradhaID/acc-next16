          ...
          <div className="overflow-x-auto">
            <table className="w-full table-auto border-collapse text-left">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800/50">
                  {filtered.map((t) => (
                  <tr key={t._id} className={`group hover:bg-emerald-50/40 dark:hover:bg-emerald-500/5 transition-all cursor-pointer${t.status === "Canceled" ? " opacity-50" : ""}`}>
                    ...
                    <td className="px-4 py-3 relative group-hover:pb-6 transition-all duration-200">
                      <Link
                        ...
                        className="font-bold text-emerald-600 dark:text-emerald-400 text-sm hover:underline"
                      >
                        {t.code}
                      </Link>
