    ...
    <div className="max-w-2xl mx-auto space-y-6 pb-10">
      ...
      <div className="bg-white dark:bg-stone-900/80 backdrop-blur-md rounded-2xl border border-stone-200/60 dark:border-stone-800/60 shadow-xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
          {error && (
            <div className="p-3.5 bg-rose-50 dark:bg-rose-950/20 border border-rose-100 dark:border-rose-900/30 text-rose-600 dark:text-rose-400 rounded-xl text-xs font-bold flex items-center gap-2">
          ...
          <div className="space-y-4">
            <FormField label="Current Password" required>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-2.5 bg-stone-50 dark:bg-stone-850/50 border border-stone-200 dark:border-stone-800 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl outline-none text-sm font-bold text-stone-900 dark:text-white placeholder:text-stone-400 transition-all"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              ...
              <div className="bg-stone-50 dark:bg-stone-950/40 p-5 rounded-xl border border-stone-200/60 dark:border-stone-800/60 flex flex-col justify-between">
                <div>
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-orange-600 mb-3">
                    Password Strength
                  </h4>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-stone-100 dark:border-stone-800/80">
            ...
            <button
              type="submit"
              disabled={saving}
              className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-600 disabled:from-stone-300 disabled:to-stone-400 disabled:cursor-not-allowed text-white px-5 py-2.5 rounded-xl font-bold text-xs shadow-md shadow-orange-500/10 transition-all hover:scale-105 active:scale-95"
            >
