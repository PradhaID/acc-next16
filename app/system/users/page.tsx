    ...
    <div className="max-w-full mx-auto space-y-4 pb-10">
      ...
      {loading ? (
        ...
        <div className="py-20 text-center bg-white dark:bg-stone-900/80 border border-gray-200 dark:border-stone-700/50 rounded-2xl shadow-sm">
          ...
          <button onClick={resetFilters} className="mt-4 text-orange-600 font-bold hover:underline">
              ...
              <div key={u._id} className="p-4">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    className="w-4 h-4 rounded border-gray-300 text-orange-600 focus:ring-orange-500 cursor-pointer mt-1 shrink-0"
                  />
                  {u.image ? (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {u.isActive !== false ? (
                        ...
                        <span className="shrink-0 inline-flex items-center gap-1 text-[9px] font-black uppercase tracking-wider text-rose-600 dark:text-rose-400">
                    ...
                    {u.groupName && (
                      <p className="text-[10px] text-orange-600 dark:text-orange-400 font-bold truncate mt-0.5">{u.groupName}</p>
                    )}
            ...
            <div className="overflow-x-auto">
              <table className="w-full table-auto border-collapse text-left">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-stone-700/30">
                  {filtered.map((u) => (
                    <tr key={u._id} className="group hover:bg-orange-50/20 dark:hover:bg-orange-500/5 transition-all">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-3 mt-0.5">
                              {canEditUser && (
                                <Link
                                  href={`/system/users/edit/${u._id}`}
                                  className="text-orange-600 hover:text-orange-800 dark:text-orange-400 dark:hover:text-orange-300 text-[10px] font-black uppercase tracking-wider"
                                >
                                  {t("actions.edit")}
                                </Link>
                              )}
                      ...
                      <td className="px-4 py-3">
                        {u.groupName ? (
                          <span className="text-xs font-bold text-orange-600 dark:text-orange-400">{u.groupName}</span>
                        ) : (
