    ...
    return (
        <div className="max-w-full mx-auto space-y-6 pb-10">
            <PageHeader
                ...
                subtitle={
                    <>
                        Editing: <span className="font-bold text-orange-600">{form.name || "..."}</span>
                    </>
                }
                actions={
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border border-amber-200/60 dark:border-amber-900/40 rounded-2xl p-4 space-y-4">
                        ...
                        <div className="space-y-3">
                            <div>
                                <label className="text-[10px] uppercase font-bold text-amber-600/70 dark:text-amber-400/70">Meta Title</label>
                                <input
                                    name="metaTitle"
                            ...
                            <div>
                                <label className="text-[10px] uppercase font-bold text-amber-600/70 dark:text-amber-400/70">Meta Description</label>
                                <textarea
