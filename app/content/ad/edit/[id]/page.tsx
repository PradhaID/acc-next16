    ...
    if (!ad) {
        return (
            <div className="max-w-4xl mx-auto py-24 text-center space-y-4">
                ...
                <Link href="/content/ad" className="inline-block px-6 py-2 bg-emerald-600 text-white rounded-xl shadow-lg hover:bg-emerald-700 transition-colors uppercase text-xs font-black tracking-widest">
                    {t("ad.goBack")}
                </Link>
            </div>
        );
